...
- `approved_label`: `pending:chip_aes_testplan.hjson`
- `doc_anchor`: `chip_aes_testplan.hjson`
- `module_name_prefix`: `chip_aes_testplan.hjson`
- `bridge_edge_count`: 8

## Inferred Hardware Role

`chip_aes_testplan.hjson` appears as a hardware/IP block with code evidence and spec/document anchors. Use this page as the linking surface between RTL/DV/SVA files and specification sections.
...
- When a code-only query mentions `chip_aes_testplan.hjson`, use this hardware description to expand toward spec anchors.
