# Spec Document: opentitan/hw/top_earlgrey/data/ip/chip_flash_ctrl_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\ip\chip_flash_ctrl_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\ip\chip_flash_ctrl_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 15777
  ...
  testpoints: [
    ...
    }
    {
      ...
      desc: '''Verify the lc_escalate_en signal from LC ctrl.
            ...
            - Confirm flash accesses are disabled by erroring if the device executes the ISR.
