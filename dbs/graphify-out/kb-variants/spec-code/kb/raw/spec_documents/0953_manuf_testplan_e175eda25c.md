# Spec Document: opentitan/sw/device/silicon_creator/manuf/data/manuf_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\sw\device\silicon_creator\manuf\data\manuf_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\sw\device\silicon_creator\manuf\data\manuf_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 23354
...

    {
      ...
      desc: '''Provision RMA unlock token.
            ...
            ***Device Identity***
            ...
            The OWNER_SW_CFG_ROM_KEYMGR_OTP_MEAS_EN OTP must be configured so that the
            ...
            the production OTP configurations.
            ...
            - Configure OWNER_SW_CFG_ROM_KEYMGR_OTP_MEAS_EN OTP to switch to attestation mode
