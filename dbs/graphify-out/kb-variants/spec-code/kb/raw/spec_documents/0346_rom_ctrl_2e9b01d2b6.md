# Spec Document: opentitan/hw/ip/rom_ctrl/data/rom_ctrl.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\ip\rom_ctrl\data\rom_ctrl.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\ip\rom_ctrl\data\rom_ctrl.hjson`
- Original extension: `.hjson`
- Original bytes: 11488
...
// SPDX-License-Identifier: Apache-2.0
{
  ...
  param_list: [
    ...
    // This parameter is overridden by topgen to set the actual ROM size.
  ...
  features: [
    { name: "ROM_CTRL.SCRAMBLED",
      desc: '''
        ROM data is scrambled.
      '''
    },
    { name: "ROM_CTRL.DIGESTS",
      desc: '''
        A signature of the ROM contents is computed at startup.
        This is available in the DIGEST_<i> CSRs.
      '''
    },
    { name: "ROM_CTRL.EXP_DIGESTS",
      desc: '''
        The chip has an expected ROM signature.
        This is available in the EXP_DIGEST_<i> CSRs.
      '''
    },
  ]
