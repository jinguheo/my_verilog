# Spec Document: opentitan/hw/top_earlgrey/data/otp/otp_ctrl_img_creator_sw_cfg.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\otp\otp_ctrl_img_creator_sw_cfg.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\otp\otp_ctrl_img_creator_sw_cfg.hjson`
    ...
    partitions: [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    // Disable SPX+ signature verification. See the definition
                    // of `kSigverifySpxDisabledOtp` in
