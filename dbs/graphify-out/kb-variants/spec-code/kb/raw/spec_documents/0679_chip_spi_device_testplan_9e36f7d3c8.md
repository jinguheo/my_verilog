# Spec Document: opentitan/hw/top_earlgrey/data/ip/chip_spi_device_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\ip\chip_spi_device_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\ip\chip_spi_device_testplan.hjson`
  ...
  testpoints: [
    ...
    }
    {
      ...
      desc: '''Verify spi_device output values when spi_device is disabled or the chip is sleeping.
               ...
               which is why the "features" list is empty. It may be reclassified in the future.
             '''
      stage: V3
      si_stage: SV3
      lc_states: [ "PROD" ]
