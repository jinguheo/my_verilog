# Spec Document: opentitan/hw/top_darjeeling/ip_autogen/racl_ctrl/data/racl_ctrl.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_darjeeling\ip_autogen\racl_ctrl\data\racl_ctrl.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_darjeeling\ip_autogen\racl_ctrl\data\racl_ctrl.hjson`
...
#
{
  ...
  registers: [
    { name: "POLICY_ALL_RD_WR_SHADOWED"
      desc: '''
      ...
      fields: [
        ...
        { bits: "15:0"
          ...
          resval: 7
          desc: '''
                Read permission for policy ALL_RD_WR
                '''
        }
      ]
    }
    { reserved: "1" }
    { name: "POLICY_ROT_PRIVATE_SHADOWED"
      desc: '''
      ...
      fields: [
        { bits: "31:16"
          ...
          resval: 1
          desc: '''
                Write permission for policy ROT_PRIVATE
                '''
        }
        { bits: "15:0"
          name: "read_perm"
          resval: 1
          desc: '''
                Read permission for policy ROT_PRIVATE
                '''
        }
      ]
    }
    { reserved: "1" }
    { name: "POLICY_SOC_ROT_SHADOWED"
      desc: '''
      ...
      fields: [
        { bits: "31:16"
          ...
          resval: 5
          desc: '''
                Write permission for policy SOC_ROT
                '''
        }
        { bits: "15:0"
          name: "read_perm"
          resval: 5
          desc: '''
                Read permission for policy SOC_ROT
                '''
        }
      ]
    }
