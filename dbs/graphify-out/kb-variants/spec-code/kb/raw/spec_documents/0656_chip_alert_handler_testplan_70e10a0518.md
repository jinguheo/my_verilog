# Spec Document: opentitan/hw/top_earlgrey/data/ip/chip_alert_handler_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\ip\chip_alert_handler_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\ip\chip_alert_handler_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 15168
  ...
  testpoints: [
    ...
    }
    {
      ...
      desc: '''Verify alert_handler's ping mechanism works correctly during sleep and wake up.
            ...
            - Configure alert_handler's ping timeout register to a reasonable value that won't
              cause ping timeout in normal cases.
   ...
   }
   {
      ...
      desc: '''Verify alert ping mechanism doesn't trigger spurious alerts.
            ...
            **Ping timeout calculation**
            See timeout calculations described in the
