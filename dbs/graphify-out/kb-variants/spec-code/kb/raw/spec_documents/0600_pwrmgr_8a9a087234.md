# Spec Document: opentitan/hw/top_darjeeling/ip_autogen/pwrmgr/data/pwrmgr.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_darjeeling\ip_autogen\pwrmgr\data\pwrmgr.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_darjeeling\ip_autogen\pwrmgr\data\pwrmgr.hjson`
- Original extension: `.hjson`
- Original bytes: 24568
...
// SPDX-License-Identifier: Apache-2.0
{
  ...
  features: [
    ...
    { name: "PWRMGR.LOW_POWER.SOC_PROXY_WKUP_EXTERNAL_REQ_WAKEUP_ENABLE"
      desc: "Enable wakeup request wkup_external_req from soc_proxy."
    }
    { name: "PWRMGR.LOW_POWER.SOC_PROXY_WKUP_EXTERNAL_REQ_WAKEUP_REQUEST"
      desc: "Wakeup request wkup_external_req from soc_proxy."
    }
    ...
    { name: "PWRMGR.RESET.SOC_PROXY_RST_REQ_EXTERNAL_ENABLE",
      desc: "Enable reset request from soc_proxy."
    }
    { name: "PWRMGR.RESET.SOC_PROXY_RST_REQ_EXTERNAL_REQUEST",
      desc: "Reset request from soc_proxy."
    }
  ...
  param_list: [
    ...
    { name: "SOC_PROXY_WKUP_EXTERNAL_REQ_IDX",
      desc: "Vector index for soc_proxy wkup_external_req, applies for WAKEUP_EN, WAKE_STATUS and WAKE_INFO",
      type: "int",
      default: "2",
      local: "true"
    },
    ...
    { name: "RESET_EN",
      ...
      fields: [
        { bits: "0",
          name: "EN_0",
          resval: "0"
          desc: "Reset enable for aon_timer_aon: aon_timer_rst_req.",
        },
        { bits: "1",
          name: "EN_1",
          resval: "1"
          desc: "Reset enable for soc_proxy: rst_req_external.",
        },
      ]
