# Spec Document: opentitan/hw/top_earlgrey/data/ip/chip_kmac_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\ip\chip_kmac_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\ip\chip_kmac_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 12368
...
// SPDX-License-Identifier: Apache-2.0
{
  ...
  testpoints: [
    ...
    {
      name: chip_sw_kmac_endianness
      desc: '''Verify all KMAC endianness options
      ...
      tests: []
      bazel: [
        "//sw/device/tests:kmac_endianness_test",
      ]
    }
    {
