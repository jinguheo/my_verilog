# Spec Document: opentitan/hw/ip/csrng/data/csrng.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\ip\csrng\data\csrng.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\ip\csrng\data\csrng.hjson`
- Original extension: `.hjson`
- Original bytes: 34903
...
{ name:               "csrng",
  ...
  registers: [
        ...
        { bits: "5:3",
          ...
          enum: [
            ...
            { value: "1",
              name: "INVALID_ACMD",
              desc: '''
                    Request completed with an invalid application command error.
                    This error indicates that the issued application command doesn't represent a valid operation.
                    '''
            },
            { value: "2",
              name: "INVALID_GEN_CMD",
              desc: '''
                    Request completed with an invalid counter DRBG generation command error.
            ...
            { value: "3",
              name: "INVALID_CMD_SEQ",
              desc: '''
                    This error indicates that the last command was issued out of sequence.
            ...
            { value: "4",
              name: "RESEED_CNT_EXCEEDED",
              desc: '''
                    This error indicates that the number of generate requests between reseeds exceeded the maximum number allowed (see !!RESEED_INTERVAL).
    ...
    {
      name: "FIPS_FORCE",
      desc: "FIPS/CC compliance flag forcing register",
      swaccess: "rw",
      hwaccess: "hro",
      regwen: "REGWEN",
      fields: [
    ...
    },
    {
      ...
      fields: [
        ...
        { bits: "3",
          name: "FIPS_FORCE_ENABLE_FIELD_ALERT",
          desc: '''
