# Spec Document: opentitan/hw/top_earlgrey/data/ip/chip_rstmgr_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\ip\chip_rstmgr_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\ip\chip_rstmgr_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 10224
  ...
  testpoints: [
    ...
    }
    {
      ...
      desc: '''Verify the expected values from the `cpu_info` CSR on reset.
            ...
            This can be an important diagnostic tool, so setting it to SV1.
