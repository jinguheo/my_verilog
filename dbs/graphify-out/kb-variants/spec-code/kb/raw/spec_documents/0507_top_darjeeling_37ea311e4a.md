# Spec Document: opentitan/hw/top_darjeeling/data/top_darjeeling.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_darjeeling\data\top_darjeeling.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_darjeeling\data\top_darjeeling.hjson`
- Original extension: `.hjson`
- Original bytes: 82670
...
{ name: "darjeeling",
  ...
  power: {
    ...
    // Ibex halt feature via additional ROM Control input
  ...
  resets: {
    ...
    nodes: [
      ...
      { name: "lc_src",         gen: false, type: "int",                    clock: "io" }
      { name: "sys_src",        gen: false, type: "int",                    clock: "io" }
      ...
      { name: "spi_device",     gen: true,  type: "top", parent: "lc_src", clock: "io", sw: true }
      { name: "spi_host0",      gen: true,  type: "top", parent: "lc_src", clock: "io", sw: true }
      { name: "i2c0",           gen: true,  type: "top", parent: "lc_src", clock: "io", sw: true },
    ]
  }
  ...
  module: [
    { name: "uart0",    // instance name
      type: "uart",     // Must be matched to the ip name in `ip.hjson` (_reg, _cfg permitted)
                        // and `hw/ip/{type}`
    ...
    { name: "spi_device",
      type: "spi_device",
      clock_srcs: {clk_i: "io", scan_clk_i: "io"},
      clock_group: "peri",
    ...
    { name: "otp_ctrl",
      ...
      clock_srcs: {clk_i: "io", clk_edn_i: "main"},
      clock_group: "secure",
      reset_connections: {rst_ni: "lc_io", rst_edn_ni: "lc"},
      base_addrs: {
    ...
    { name: "lc_ctrl",
      type: "lc_ctrl",
      clock_srcs: {clk_i: "io", clk_kmac_i: "main"},
      clock_group: "secure",
      reset_connections: {rst_ni: "lc_io", rst_kmac_ni: "lc"},
      base_addrs: {
    ...
    { name: "rstmgr_aon",
      ...
      clock_srcs: {
        ...
        clk_por_i: "io", clk_aon_i: "aon", clk_main_i: "main", clk_io_i: "io"
      },
      clock_group: "powerup",
      reset_connections: {
        rst_ni: {
    ...
    { name: "aon_timer_aon",
      ...
      clock_srcs: {clk_i: "io", clk_aon_i: "aon"},
      clock_group: "timers",
      reset_connections: {rst_ni: "lc_io", rst_aon_ni: "lc_aon"},
      domain: ["Aon"],
      base_addr: {
        hart: "0x30470000",
      },
    ...
    { name: "sram_ctrl_ret_aon",
      type: "sram_ctrl",
      clock_srcs: {clk_i: "io", clk_otp_i: "io"},
      clock_group: "infra",
      reset_connections: {rst_ni: "lc_io", rst_otp_ni: "lc_io"}
      domain: ["Aon"],
      param_decl: {
        InstrExec: "0",
        InstSize: 4096
    ...
    { name: "otbn",
      ...
      clock_group: "trans",
      reset_connections: {rst_ni: "lc", rst_edn_ni: "lc", rst_otp_ni: "lc_io"},
      base_addr: {
        hart: "0x21130000",
      },
    },
    ...
    { name: "sram_ctrl_main",
      type: "sram_ctrl",
      clock_srcs: {clk_i: "main", clk_otp_i: "io"},
      clock_group: "infra",
      reset_connections: {rst_ni: "lc", rst_otp_ni: "lc_io"},
  ...
  inter_module: {
    'connect': {
      'ast.obs_ctrl'            : ['otp_macro.obs_ctrl']
      ...
      'pwrmgr_aon.strap'        : ['gpio.strap_en',
                                   'rv_dm.strap_en'],
...
//      'lc_ctrl.lc_otp_vendor_test' : ['otp_ctrl.lc_otp_vendor_test'],
      ...
      'lc_ctrl.lc_raw_test_rma'    : ['soc_dbg_ctrl.lc_raw_test_rma']
      ...
      // Darjeeling does not have bypassable clocks. Therefore always ack are req
      ...
      'soc_proxy.dma_tl_h2d' : ['dma.ctn_tl_h2d']
      'soc_proxy.dma_tl_d2h' : ['dma.ctn_tl_d2h']

      'soc_proxy.ctn_tl_h2d' : ['ac_range_check.ctn_tl_h2d']
      'soc_proxy.ctn_tl_d2h' : ['ac_range_check.ctn_tl_d2h']
    }
  ...
  xbar: [
    ...
    { name: "peri",
      ...
      clock_group: "infra",
      reset: "lc_io",
      reset_connections: {rst_peri_ni: "lc_io"},
    },
    { name: "mbx",
    ...
    { name: "dbg",
      clock_srcs: {clk_dbg_i: "main", clk_peri_i: "io"},
      clock_group: "infra",
      reset: "lc",
      reset_connections: {rst_dbg_ni: "lc", rst_peri_ni: "lc_io"},
    },
  ],
  ...
  pinout: {
    ...
    pads: [
      ...
      { name: 'JTAG_TCK'        , type: 'InputStd',     bank: 'VIO' , connection: 'manual', desc: 'JTAG TCK signal'},
      { name: 'JTAG_TMS'        , type: 'InputStd',     bank: 'VIO' , connection: 'manual', desc: 'JTAG TMS signal'},
      { name: 'JTAG_TDI'        , type: 'InputStd',     bank: 'VIO' , connection: 'manual', desc: 'JTAG TDI signal'},
      { name: 'JTAG_TDO'        , type: 'BidirStd',     bank: 'VIO' , connection: 'manual', desc: 'JTAG TDO signal'},
      { name: 'JTAG_TRST_N'     , type: 'InputStd',     bank: 'VIO' , connection: 'manual', desc: 'JTAG TRST_N signal'},
