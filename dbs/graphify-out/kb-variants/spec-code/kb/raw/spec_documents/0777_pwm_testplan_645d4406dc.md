# Spec Document: opentitan/hw/top_earlgrey/ip_autogen/pwm/data/pwm_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\ip_autogen\pwm\data\pwm_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\ip_autogen\pwm\data\pwm_testplan.hjson`
...
// SPDX-License-Identifier: Apache-2.0
{
    ...
    }
   {
    ...
    }
    {
      name: regwen
      desc: '''
            Set the DUT operating with a configuration that produces clear variation on all of the PWM outputs.
            Lock the configuration using REGWEN and then attempt to change the configuration.
            The DUT, monitors and scoreboard should continue unaffected until the DUT is reset.
            '''
      stage: V2
      tests: ["pwm_regwen"]
    }
