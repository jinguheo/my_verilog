# Spec Document: opentitan/hw/top_englishbreakfast/ip_autogen/flash_ctrl/data/flash_ctrl_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_englishbreakfast\ip_autogen\flash_ctrl\data\flash_ctrl_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_englishbreakfast\ip_autogen\flash_ctrl\data\flash_ctrl_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 20255
...
// SPDX-License-Identifier: Apache-2.0
{
  ...
  import_testplans: ["hw/dv/tools/dvsim/testplans/csr_testplan.hjson",
                     ...
                     "flash_ctrl_sec_cm_testplan.hjson"]
  testpoints: [
    {
      name: smoke
      desc: '''
    ...
    }
    {
      ...
      desc: '''
            ...
            any catastrophic event happens.
              ...
              - Read flash from controller without setting start op.
              - Issue rd_fifo read more that CONTROL.NUM field value.
    ...
    }
    {
      ...
      desc: '''
            ...
            that scramble Keys are Read from the OTP and sent into the Flash Ctrl.  Also verify that programmed
    ...
    }
    {
      ...
      desc: '''
            Verify the isolated information partitions. Accessibility is controlled by Life
    ...
    }
    {
      ...
      desc: '''
            Verify error handling process during the RMA wipe process.
    ...
    }
    {
      ...
      desc: '''
            ...
            Send flash read request over slow path followed by fast path.
  ...
  covergroups: [
    ...
    }
    {
      name: erase_susp_cg
      desc: '''
            Covers if request of erase suspension occurred.
            '''
    }
    {
    ...
    }
    {
      ...
      desc: '''
            ...
            After that record the config value (scramble_en and ecc_en) of the region.
