# Spec Document: opentitan/hw/ip/aes/data/aes.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\ip\aes\data\aes.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\ip\aes\data\aes.hjson`
- Original extension: `.hjson`
- Original bytes: 46429
...
# AES register template
{
  ...
  countermeasures: [
    ...
    { name: "GCM.CONFIG.SHADOW",
      desc: "GCM control register shadowed."
    }
    { name: "GCM.CONFIG.SPARSE",
      desc: "Critical fields in GCM control register one-hot encoded."
    }
    { name: "KEY.SIDELOAD",
    ...
    { name: "KEY.MASKING",
      desc: '''
        ...
        1st-order masking of the GHASH operation.
    ...
    { name: "GHASH.FSM.SPARSE",
      desc: "The GHASH FSM uses a sparse state encoding."
    }
    { name: "CTRL.SPARSE",
    ...
    { name: "MAIN.FSM.LOCAL_ESC",
      desc: '''
        ...
        Can be triggered by MAIN.FSM.SPARSE, MAIN.FSM.REDUN, CTRL.SPARSE, as well as CIPHER.FSM.LOCAL_ESC, CTR.FSM.LOCAL_ESC, GHASH.FSM.LOCAL_ESC.
      '''
    }
    ...
    { name: "GHASH.FSM.LOCAL_ESC",
      desc: '''
        The GHASH FSM moves to a terminal error state upon local escalation.
        Can be triggered by GHASH.FSM.SPARSE, CTRL.SPARSE, as well as MAIN.FSM.LOCAL_ESC.
      '''
    }
  ...
  { name: "CTRL_GCM_SHADOWED",
    ...
    fields: [
      { bits: "5:0",
        ...
        tags: ["shadowed_reg_path:u_aes_core.u_ctrl_gcm_reg_shadowed.gen_ctrl_gcm_reg_shadowed.u_ctrl_gcm_reg_shadowed_phase"]
      }
      { bits: "10:6",
        ...
        '''
        tags: ["shadowed_reg_path:u_aes_core.u_ctrl_gcm_reg_shadowed.gen_ctrl_gcm_reg_shadowed.u_ctrl_gcm_reg_shadowed_num_valid_bytes"]
      }
    ]
    tags: [// Updated by the HW.
           // Updates based on writes to this reg (reset test possible).
