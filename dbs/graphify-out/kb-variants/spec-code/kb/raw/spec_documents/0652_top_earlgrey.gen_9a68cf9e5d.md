# Spec Document: opentitan/hw/top_earlgrey/data/autogen/top_earlgrey.gen.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\autogen\top_earlgrey.gen.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\autogen\top_earlgrey.gen.hjson`
- Original extension: `.hjson`
- Original bytes: 667411
...
//                -o hw/top_earlgrey/
{
  ...
  [
    ...
    }
    {
      ...
      [
        ...
        {
          name: NumRmaAckSigs
          desc: Number of NVM RMA wiping response signals
          type: int
          default: "2"
          local: "true"
          expose: "true"
      ...
      [
        ...
        }
        {
          ...
          end_idx: -1
          top_type: broadcast
          top_signame: lc_ctrl_lc_nvm_rma_req
          index: -1
        }
        {
          name: lc_nvm_rma_ack
          ...
          end_idx: -1
          top_type: one-to-N
          top_signame: lc_ctrl_lc_nvm_rma_ack
          index: -1
        }
        {
          name: lc_nvm_rma_seed
          ...
          end_idx: -1
          top_type: broadcast
          top_signame: lc_ctrl_lc_nvm_rma_seed
          index: -1
        }
        {
          name: lc_check_byp_en
    ...
    }
    {
      ...
      [
        {
          name: csrng_cmd
          desc: EDN supports a single CSRNG application interface.
          struct: csrng
          package: csrng_pkg
          type: req_rsp
          act: req
        ...
        {
          name: edn
          desc: Every endpoint has its own peripheral port.
          struct: edn
          package: edn_pkg
          type: req_rsp
          act: rsp
  ...
  inter_module:
  {
    connect:
    {
      ...
      flash_ctrl.otp:
      [
        otp_ctrl.nvm_otp_key
      ]
      lc_ctrl.lc_nvm_rma_seed:
      [
        flash_ctrl.rma_seed
      ]
      ...
      lc_ctrl.lc_nvm_rma_req:
      [
        flash_ctrl.rma_req
        otbn.lc_rma_req
      ]
      lc_ctrl.lc_nvm_rma_ack:
      [
        flash_ctrl.rma_ack
        otbn.lc_rma_ack
      ]
  ...
  alert_connections:
  {
    ...
    module_spi_device:
    {
      tx_expr: alert_tx[5:5]
      rx_expr: alert_rx[5:5]
      async_expr: alert_handler_reg_pkg::AsyncOn[5:5]
      comments:
      [
    ...
    module_i2c0:
    {
      tx_expr: alert_tx[6:6]
      rx_expr: alert_rx[6:6]
      async_expr: alert_handler_reg_pkg::AsyncOn[6:6]
      comments:
      [
    ...
    module_i2c1:
    {
      tx_expr: alert_tx[7:7]
      rx_expr: alert_rx[7:7]
      async_expr: alert_handler_reg_pkg::AsyncOn[7:7]
      comments:
      [
    ...
    module_i2c2:
    {
      tx_expr: alert_tx[8:8]
      rx_expr: alert_rx[8:8]
      async_expr: alert_handler_reg_pkg::AsyncOn[8:8]
      comments:
      [
    ...
    module_pattgen:
    {
      tx_expr: alert_tx[9:9]
      rx_expr: alert_rx[9:9]
      async_expr: alert_handler_reg_pkg::AsyncOn[9:9]
      comments:
      [
    ...
    module_rv_timer:
    {
      tx_expr: alert_tx[10:10]
      rx_expr: alert_rx[10:10]
      async_expr: alert_handler_reg_pkg::AsyncOn[10:10]
      comments:
      [
    ...
    module_otp_ctrl:
    {
      tx_expr: alert_tx[15:11]
      rx_expr: alert_rx[15:11]
      async_expr: alert_handler_reg_pkg::AsyncOn[15:11]
      comments:
      [
    ...
    module_lc_ctrl:
    {
      tx_expr: alert_tx[18:16]
      rx_expr: alert_rx[18:16]
      async_expr: alert_handler_reg_pkg::AsyncOn[18:16]
      comments:
      [
    ...
    module_rstmgr_aon:
    {
      tx_expr: alert_tx[24:23]
      rx_expr: alert_rx[24:23]
      async_expr: alert_handler_reg_pkg::AsyncOn[24:23]
      comments:
      [
    ...
    module_adc_ctrl_aon:
    {
      tx_expr: alert_tx[28:28]
      rx_expr: alert_rx[28:28]
      async_expr: alert_handler_reg_pkg::AsyncOn[28:28]
      comments:
      [
    ...
    module_pwm_aon:
    {
      tx_expr: alert_tx[29:29]
      rx_expr: alert_rx[29:29]
      async_expr: alert_handler_reg_pkg::AsyncOn[29:29]
      comments:
      [
    ...
    module_pinmux_aon:
    {
      tx_expr: alert_tx[30:30]
      rx_expr: alert_rx[30:30]
      async_expr: alert_handler_reg_pkg::AsyncOn[30:30]
      comments:
      [
    ...
    {
      tx_expr: alert_tx[31:31]
      rx_expr: alert_rx[31:31]
      async_expr: alert_handler_reg_pkg::AsyncOn[31:31]
      comments:
      [
        alert_handler[31]: fatal_fault
      ]
    }
    module_sensor_ctrl_aon:
    {
    ...
    {
      tx_expr: alert_tx[34:34]
      rx_expr: alert_rx[34:34]
      async_expr: alert_handler_reg_pkg::AsyncOn[34:34]
      comments:
      [
    ...
    module_flash_ctrl:
    {
      tx_expr: alert_tx[39:35]
      rx_expr: alert_rx[39:35]
      async_expr: alert_handler_reg_pkg::AsyncOn[39:35]
      comments:
      [
    ...
    module_rv_dm:
    {
      tx_expr: alert_tx[40:40]
      rx_expr: alert_rx[40:40]
      async_expr: alert_handler_reg_pkg::AsyncOn[40:40]
      comments:
      [
    ...
    module_rv_plic:
    {
      tx_expr: alert_tx[41:41]
      rx_expr: alert_rx[41:41]
      async_expr: alert_handler_reg_pkg::AsyncOn[41:41]
      comments:
      [
    ...
    module_aes:
    {
      tx_expr: alert_tx[43:42]
      rx_expr: alert_rx[43:42]
      async_expr: alert_handler_reg_pkg::AsyncOn[43:42]
      comments:
      [
    ...
    module_kmac:
    {
      tx_expr: alert_tx[46:45]
      rx_expr: alert_rx[46:45]
      async_expr: alert_handler_reg_pkg::AsyncOn[46:45]
      comments:
      [
    ...
    {
      tx_expr: alert_tx[59:59]
      rx_expr: alert_rx[59:59]
      async_expr: alert_handler_reg_pkg::AsyncOn[59:59]
      comments:
      [
    ...
    module_rom_ctrl:
    {
      tx_expr: alert_tx[60:60]
      rx_expr: alert_rx[60:60]
      async_expr: alert_handler_reg_pkg::AsyncOn[60:60]
      comments:
      [
    ...
    module_rv_core_ibex:
    {
      tx_expr: alert_tx[64:61]
      rx_expr: alert_rx[64:61]
      async_expr: alert_handler_reg_pkg::AsyncOn[64:61]
      comments:
      [
  ...
  inter_signal:
  {
    ...
    [
      ...
      }
      {
        ...
        act: req
        suffix: rsp
        default: otp_ctrl_pkg::NVM_OTP_KEY_RSP_DEFAULT
      }
      {
        package: lc_ctrl_pkg
        struct: lc_nvm_rma_seed
        signame: lc_ctrl_lc_nvm_rma_seed
        width: 1
        type: uni
        end_idx: -1
        act: req
      ...
      }
      {
        package: lc_ctrl_pkg
        struct: lc_tx
        signame: lc_ctrl_lc_nvm_rma_req
        width: 1
        type: uni
        end_idx: -1
        act: req
      ...
      }
      {
        package: lc_ctrl_pkg
        struct: lc_tx
        signame: lc_ctrl_lc_nvm_rma_ack
        width: 2
        type: uni
        end_idx: -1
        act: rcv
