# Spec Document: opentitan/hw/ip/aes/data/aes_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\ip\aes\data\aes_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\ip\aes\data\aes_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 10936
...
// SPDX-License-Identifier: Apache-2.0
{
  ...
  testpoints: [
   ...
   // }
    ...
    {
      name: nist_test_vectors_gcm
      desc: '''
            Verify that the DUT handles the NIST GCM test vectors correctly.'''
      stage: V2
    ...
    }
    {
      ...
      desc: '''
            ...
            When triggered, save the current context, clear the entire state, restore the context, and proceed with the operation.
            '''
      stage: V2
...
covergroups: [
    ...
    }
    {
     name: gcm_len_cg
     desc: '''
           Covers that, when in AES-GCM mode, different sized AAD and TEXT blocks have
           been tested. This includes:
           - enc / dec
           - zero sized AAD block
           - Full and partial AAD / TEXT blocks
           - Single and multiple AAD / TEXT blocks
           '''
    }
    {
     name: ctrl_aux_cg
