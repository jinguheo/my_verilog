# Spec Document: opentitan/hw/top_earlgrey/data/ip/chip_adc_ctrl_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\ip\chip_adc_ctrl_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\ip\chip_adc_ctrl_testplan.hjson`
...
// SPDX-License-Identifier: Apache-2.0
{
  ...
  testpoints: [
    ...
    }
    {
      ...
      desc:"Verify that ADC can sample from channel 0 and 1 in normal mode."
    ...
    }
    {
      ...
      desc:"Verify that ADC can sample from channel 0 and 1 in normal mode with oneshot filter config."
