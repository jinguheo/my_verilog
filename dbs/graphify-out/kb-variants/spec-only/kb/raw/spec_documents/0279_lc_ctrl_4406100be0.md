# Spec Document: opentitan/hw/ip/lc_ctrl/data/lc_ctrl.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\ip\lc_ctrl\data\lc_ctrl.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\ip\lc_ctrl\data\lc_ctrl.hjson`
- Original extension: `.hjson`
- Original bytes: 59708
...
// SPDX-License-Identifier: Apache-2.0
{
  ...
  param_list: [
    ...
    { name:      "RndCnstLcKeymgrDivInvalid",
      ...
      randcount: "128",
      randtype:  "data", // Compile-time random bits
    }
  ...
  inter_signal_list: [
    ...
    // Macro-specific test signals to/from LC TAP/DMI
    { struct:  "otp_test"
      type:    "req_rsp"
    ...
    // life cycle token hashing command to KMAC
    { struct:  "app"
      type:    "req_rsp"
      name:    "kmac_data"
      act:     "req"
    ...
    { struct:  "lc_tx"
      type:    "uni"
      # We have multiple response channels for this signal since the RMA wiping
      # requests can go to multiple modules that perform wiping in parallel.
      # For security reasons, this signal is not daisy-chained - see #19136 for
      # context. This needs to be aligned with the NumRmaAckSigs parameter.
      width:   "2"
      name:    "lc_nvm_rma_ack"
      act:     "rcv"
      # Default to ON so that this still works even if not all channels are
      # connected.
  ...
  countermeasures: [
    ...
    { name: "TRANSITION.CTR.BKGN_CHK",
      desc: '''
            ...
            24 state transitions in order to guard against brute-forcing.
            '''
    }
