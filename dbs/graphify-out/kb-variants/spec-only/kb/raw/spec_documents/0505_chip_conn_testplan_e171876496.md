# Spec Document: opentitan/hw/top_darjeeling/data/chip_conn_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_darjeeling\data\chip_conn_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_darjeeling\data\chip_conn_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 38605
...
// SPDX-License-Identifier: Apache-2.0
{
  ...
  testpoints: [
    ...
    {
      name: cg_en_io_infra
      desc: '''Verify clkmgr's cg_en_o.io_infra is connected to:
            - alert_handler's lpg_cg_en_i[6]
            - alert_handler's lpg_cg_en_i[11]
            '''
      stage: V2
      tests: ["clkmgr_io_infra_alert_9_cg_en",
              "clkmgr_io_infra_alert_11_cg_en"]
      tags: ["conn"]
    }
    {
      name: cg_en_io_peri
      desc: '''Verify clkmgr's cg_en_o.io_peri is connected to the following:
            - alert_handler's lpg_cg_en_i[2:0]
            - alert_handler's lpg_cg_en_i[5]
            '''
      stage: V2
      tests: ["clkmgr_io_peri_alert_0_cg_en",
              "clkmgr_io_peri_alert_1_cg_en",
              "clkmgr_io_peri_alert_2_cg_en",
              "clkmgr_io_peri_alert_5_cg_en"]
      tags: ["conn"]
    }
    {
      name: cg_en_io_powerup
      desc: '''Verify clkmgr's cg_en_o.io_powerup is connected to the following:
            - alert_handler's lpg_cg_en_i[7:6]
            '''
      stage: V2
      tests: ["clkmgr_io_powerup_alert_6_cg_en",
              "clkmgr_io_powerup_alert_7_cg_en"]
      tags: ["conn"]
    }
    {
      name: cg_en_io_secure
      desc: '''Verify clkmgr's cg_en_o.io_secure is connected to the following:
            - alert_handler's lpg_cg_en_i[4]
            '''
      stage: V2
      tests: ["clkmgr_io_secure_alert_4_cg_en"]
      tags: ["conn"]
    }
    {
      name: cg_en_io_timers
      desc: '''Verify clkmgr's cg_en_o.io_timers is connected to the following:
            - alert_handler's lpg_cg_en_i[3]
            - alert_handler's lpg_cg_en_i[8]
            '''
      stage: V2
      tests: ["clkmgr_io_timers_alert_3_cg_en",
              "clkmgr_io_timers_alert_8_cg_en"]
      tags: ["conn"]
    }
    {
      name: cg_en_main_aes
      desc: '''Verify clkmgr's cg_en_o.main_aes is connected to alert_handler's lpg_cg_en[14].'''
      stage: V2
      tests: ["clkmgr_main_aes_alert_14_cg_en"]
      tags: ["conn"]
    }
    {
      name: cg_en_main_infra
      desc: '''Verify clkmgr's cg_en_o.main_infra isconnected to the following:
            - alert_handler's lpg_cg_en_i[10]
            - alert_handler's lpg_cg_en_i[12]
            '''
      stage: V2
      tests: ["clkmgr_main_infra_alert_10_cg_en",
              "clkmgr_main_infra_alert_12_cg_en"]
      tags: ["conn"]
    }
    {
      name: cg_en_main_secure
      desc: '''Verify clkmgr's cg_en_o.main_secure is connected to alert_handler's lpg_cg_en[13].'''
      stage: V2
      tests: ["clkmgr_main_secure_alert_13_cg_en"]
      tags: ["conn"]
    }
    ...
    /////////////////////////
    {
      ...
      desc: '''Verify clkmgr's `clk_io_powerup` is connected to the following blocks' clock
            input:
            - clkmgr clk_i
            - pinmux clk_i
            - pwrmgr clk_i
    ...
    /////////////////////////
    {
      name: clkmgr_clk_io_secure
      desc: '''Verify clkmgr's `clk_io_secure` is connected to the following blocks' clock
            input:
            - alert_handler clk_i
            - lc_ctrl clk_i
            - otbn clk_otp_i
    ...
    /////////////////////////
    {
      name: clkmgr_clk_io_timers
      desc: '''Verify clkmgr's `clk_io_timers` is connected to the following blocks' clock
            input:
            - aon_timer clk_i
            - rv_timer clk_i
            '''
    ...
    {
      name: rst_lc_io_aon
      desc: '''Verify rstmgr's rst_lc_io_n[0] is connected to the following:
            - aon_timer's rst_ni
            - clkmgr's rst_ni
            - clkmgr's rst_io_ni
            - pinmux's rst_ni
            ...
            '''
      stage: V2
      tests: ["rstmgr_lc_io_aon_aon_timer_rst_ni",
              "rstmgr_lc_io_aon_clkmgr_rst_ni",
              "rstmgr_lc_io_aon_clkmgr_rst_io_ni",
              "rstmgr_lc_io_aon_pwrmgr_rst_lc_ni",
              "rstmgr_lc_io_aon_pinmux_rst_ni",
              "rstmgr_lc_io_aon_sram_ctrl_ret_rst_otp_ni",
              "rstmgr_lc_io_aon_rstmgr_rst_ni"]
      tags: ["conn"]
    }
    {
      name: rst_lc_io_d0
      desc: '''Verify rstmgr's rst_lc_io_n[1] is connected to the following:
            ...
            '''
      stage: V2
      tests: ["rstmgr_lc_io_d0_alert_handler_rst_ni",
              "rstmgr_lc_io_d0_lc_ctrl_rst_ni",
              "rstmgr_lc_io_d0_otbn_rst_otp_ni",
              "rstmgr_lc_io_d0_otp_ctrl_rst_ni",
              "rstmgr_lc_io_d0_rv_core_ibex_rst_esc_ni",
              "rstmgr_lc_io_d0_rv_core_ibex_rst_otp_ni",
              "rstmgr_lc_io_d0_sram_ctrl_main_rst_otp_ni"]
      tags: ["conn"]
    }
    {
      name: rst_lc_io_shadowed_aon
      desc: '''Verify rstmgr's rst_lc_io_shadowed_n[0] is connected to clkmgr's rst_shadowed_ni.'''
      stage: V2
      tests: ["rstmgr_lc_io_shadowed_aon_clkmgr_rst_shadowed_ni"]
      tags: ["conn"]
    }
    {
      name: rst_lc_io_shadowed_d0
      desc: '''Verify rstmgr's rst_lc_io_shadowed_n[1] is connected to alert_handler's rst_shadowed_ni.'''
      stage: V2
      tests: ["rstmgr_lc_io_shadowed_d0_alert_handler_rst_shadowed_ni"]
      tags: ["conn"]
    }
    {
      name: rst_lc_aon
    ...
    {
      name: rst_por_io_aon
      desc: '''Verify rstmgr's rst_por_io_n[0] is connected to the following:
            - clkmgr's rst_root_io_ni
      ...
      stage: V2
      tests: ["rstmgr_por_io_aon_clkmgr_rst_root_io_ni",
              "rstmgr_por_io_aon_clkmgr_rst_root_ni",
              "rstmgr_por_io_aon_pwrmgr_rst_ni",
              "rstmgr_por_io_aon_rstmgr_rst_ni"]
      tags: ["conn"]
    }
    {
    ...
    {
      name: rst_sys_io_d0
      desc: '''Verify rstmgr's rst_sys_io_n[1] is connected to the following:
            ...
            '''
      stage: V2
      tests: ["rstmgr_sys_io_d0_flash_ctrl_rst_otp_ni",
              "rstmgr_sys_io_d0_gpio_rst_ni",
    ...
    {
      name: rst_en_lc_io_aon
      desc: '''Verify rstmgr's rst_en_o.lc_io[0] connects to the following:
            - alert_handler's lpg_rst_en[11]
            - alert_handler's lpg_rst_en[15]
            '''
      stage: V2
      tests: ["rstmgr_lc_io_aon_alert_11_rst_en",
              "rstmgr_lc_io_aon_alert_15_rst_en"]
      tags: ["conn"]
    }
    {
      name: rst_en_lc_io_d0
      desc: '''Verify rstmgr's rst_en_o.lc_io[1] connects to alert_handler's lpg_rst_en[6].'''
      stage: V2
      tests: ["rstmgr_lc_io_d0_alert_6_rst_en"]
      tags: ["conn"]
    }
    {
      name: rst_en_por_io_d0
      desc: '''Verify rstmgr's rst_en_o.por_io[1] connects to alert_handler's lpg_rst_en[10].'''
      stage: V2
      tests: ["rstmgr_por_io_d0_alert_10_rst_en"]
      tags: ["conn"]
    }
    {
    ...
    {
      name: rst_en_sys_io_aon
      desc: '''Verify rstmgr's rst_en_o.sys_io[0] connects to the following:
            ...
            '''
      stage: V2
      tests: ["rstmgr_sys_io_aon_alert_12_rst_en",
              "rstmgr_sys_io_aon_alert_13_rst_en",
              "rstmgr_sys_io_aon_alert_14_rst_en",
              "rstmgr_sys_io_aon_alert_17_rst_en"]
      tags: ["conn"]
    }
    {
      name: rst_en_sys_io_d0
      desc: '''Verify rstmgr's rst_en_o.sys_io[1] connects to the following:
            - alert_handler's lpg_rst_en[0]
            - alert_handler's lpg_rst_en[5]
            - alert_handler's lpg_rst_en[16]
            '''
      stage: V2
      tests: ["rstmgr_sys_io_d0_alert_0_rst_en",
              "rstmgr_sys_io_d0_alert_5_rst_en",
              "rstmgr_sys_io_d0_alert_16_rst_en"]
      tags: ["conn"]
    }
