# Spec Document: opentitan/hw/top_earlgrey/data/top_earlgrey.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\top_earlgrey.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\top_earlgrey.hjson`
- Original extension: `.hjson`
- Original bytes: 80552
...
{ name: "earlgrey",
  ...
  resets: {
    ...
    nodes: [
      ...
      { name: "spi_host1",      gen: true,  type: "top", parent: "lc_src", clock: "io_div2", sw: true },
      { name: "usb",            gen: true,  type: "top", parent: "lc_src", clock: "usb",     sw: true },
      { name: "usb_aon",        gen: true,  type: "top", parent: "lc_src", clock: "aon",     sw: true },
      { name: "i2c0",           gen: true,  type: "top", parent: "lc_src", clock: "io_div4", sw: true },
      { name: "i2c1",           gen: true,  type: "top", parent: "lc_src", clock: "io_div4", sw: true },
      { name: "i2c2",           gen: true,  type: "top", parent: "lc_src", clock: "io_div4", sw: true },
    ]
  },
  ...
  inter_module: {
    'connect': {
      ...
      'flash_ctrl.otp'          : ['otp_ctrl.nvm_otp_key'],
      'lc_ctrl.lc_nvm_rma_seed' : ['flash_ctrl.rma_seed'],
      'otp_ctrl.sram_otp_key'   : ['sram_ctrl_main.sram_otp_key',
                                   'sram_ctrl_ret_aon.sram_otp_key',
                                   'rv_core_ibex.icache_otp_key'],
      'pwrmgr_aon.pwr_nvm'      : ['flash_ctrl.pwrmgr'],
      ...
      //                              |-> OTBN  -> LC
      'lc_ctrl.lc_nvm_rma_req' : ['flash_ctrl.rma_req', 'otbn.lc_rma_req'],
      'lc_ctrl.lc_nvm_rma_ack' : ['flash_ctrl.rma_ack', 'otbn.lc_rma_ack'],
      ...
      'usbdev.usb_aon_bus_not_idle' : ['pinmux_aon.usbdev_bus_not_idle'],
...
//      'lc_ctrl.lc_otp_vendor_test' : ['otp_ctrl.lc_otp_vendor_test'],
  ...
  pinmux: {
    ...
    num_wkup_detect: 8,
    wkup_cnt_width:  8,
    // Enable USB wakeup and hardware strap sampling for discrete OpenTitan
    ...
    { name: 'asic',
      ...
      pinmux: {
        ...
        special_signals: [
          ...
          { name: 'dft0',   pad: 'IOR5', desc: 'DFT strap signal.'   },
          { name: 'dft1',   pad: 'IOR7', desc: 'DFT strap signal.'   },
          // JTAG
