# Spec Document: opentitan/hw/top_englishbreakfast/ip_autogen/flash_ctrl/data/flash_ctrl_sec_cm_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_englishbreakfast\ip_autogen\flash_ctrl\data\flash_ctrl_sec_cm_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_englishbreakfast\ip_autogen\flash_ctrl\data\flash_ctrl_sec_cm_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 12300
...
// .../flash_ctrl/data/flash_ctrl_testplan.hjson
{
  testpoints: [
    ...
    }
    {
      ...
      desc: '''Verify the countermeasure(s) LC_CTRL.INTERSIG.MUBI.
        - Creator info partition can be read, written, erased when lc_creator_seed_sw_rw_en is true.
          ...
          Isolated info partition can be written when lc_iso_part_sw_wr_en is true,
    ...
    }
    {
      ...
      Following state machines are in this category.
    ...
    }
    {
      ...
      Error is injected by global test.
      Following counters are in this category.
    ...
    }
    {
      ...
      Error is injected by global test.
      Following FIFOs are in this category.
        - dut.u_to_rd_fifo,
