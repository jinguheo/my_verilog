# Spec Document: opentitan/hw/top_earlgrey/data/ip/chip_lc_ctrl_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\ip\chip_lc_ctrl_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\ip\chip_lc_ctrl_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 16737
    ...
    }
    {
      ...
      desc: '''Verify broadcast signals from lc_ctrl.
            ...
            - Verify that the following broadcast signals are having the right effect in the
              ...
              - lc_nvm_rma_req_o: impacts flash_ctrl (handshake with lc_nvm_rma_ack_i)
              - lc_nvm_rma_seed_o: impacts flash_ctrl
      ...
      tests: [
        ...
        "chip_sw_flash_rma_unlocked",                  // lc_nvm_rma_req_o, lc_nvm_rma_seed_o: flash_ctrl
