# Spec Document: opentitan/hw/ip/i2c/data/i2c.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\ip\i2c\data\i2c.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\ip\i2c\data\i2c.hjson`
- Original extension: `.hjson`
- Original bytes: 46274
...

{
  ...
  features: [
    { name: "I2C.MODE.HOST",
      desc: '''
            The I2C block can be configured in host mode.
            '''
    },
  ...
  registers: [
    ...
    { name: "OVRD"
      ...
      tags: [// Overriding can cause sda/scl_interference interrupts to trigger continuously.
