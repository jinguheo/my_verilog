# Spec Document: opentitan/sw/device/silicon_creator/rom/data/rom_e2e_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\sw\device\silicon_creator\rom\data\rom_e2e_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\sw\device\silicon_creator\rom\data\rom_e2e_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 57805
      ...
      desc: '''Verify that ROM initializes the keymgr correctly.
            ...
            - Verify that
              - attestation sw binding equals
                - the digest of the software readable OTP partitions if
                  `OWNER_SW_CFG_ROM_KEYMGR_OTP_MEAS_EN` is `kHardenedBoolTrue`, and
