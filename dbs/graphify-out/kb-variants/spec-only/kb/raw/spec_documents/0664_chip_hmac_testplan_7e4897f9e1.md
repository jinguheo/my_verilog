# Spec Document: opentitan/hw/top_earlgrey/data/ip/chip_hmac_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\ip\chip_hmac_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\ip\chip_hmac_testplan.hjson`
  ...
  testpoints: [
    ...
    }
    {
      ...
      desc: '''Verify HMAC secure wipe
            ...
            - Compare MAC digest against original result. The result must not match.
            '''
