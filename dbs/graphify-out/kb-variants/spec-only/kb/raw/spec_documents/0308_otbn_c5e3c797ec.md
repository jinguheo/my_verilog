# Spec Document: opentitan/hw/ip/otbn/data/otbn.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\ip\otbn\data\otbn.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\ip\otbn\data\otbn.hjson`
- Original extension: `.hjson`
- Original bytes: 27645
...
// SPDX-License-Identifier: Apache-2.0
{
  ...
  registers: [
    ...
    // The total Dmem size (from `items` below plus the scratchpad size) must be a power of two.
    // Splits that are not a power of two are possible but require to set the attribute 'unusual: "true"' below.
    { window: {
        name: "DMEM",
        items: "4096", // 16KiB visible over the bus (16KiB scratch)
        swaccess: "rw",
        data-intg-passthru: "true",
        byte-write: "false",
        desc: '''
