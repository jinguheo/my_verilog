# Spec Document: opentitan/hw/ip/edn/data/edn.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\ip\edn\data\edn.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\ip\edn\data\edn.hjson`
- Original extension: `.hjson`
- Original bytes: 29129
...
// SPDX-License-Identifier: Apache-2.0
{
  ...
  inter_signal_list: [
    { struct:  "csrng",  // csrng_req_t, csrng_rsp_t
      ...
      package: "csrng_pkg",
      desc:    '''
               EDN supports a single CSRNG application interface.
               ''',
    }
    { struct:  "edn",  // edn_req_t, edn_rsp_t
      ...
      default: "'0",
      desc:    '''
               Every endpoint has its own peripheral port.
               ''',
      package: "edn_pkg",
    }
  ],
