# Spec Document: opentitan/hw/top_englishbreakfast/data/autogen/top_englishbreakfast.gen.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_englishbreakfast\data\autogen\top_englishbreakfast.gen.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_englishbreakfast\data\autogen\top_englishbreakfast.gen.hjson`
- Original extension: `.hjson`
- Original bytes: 312461
...
//                -o hw/top_englishbreakfast/
{
  ...
  [
    {
      ...
      outgoing_alert: englishbreakfast
      clock_connections:
      {
    ...
    }
    {
      ...
      [
        ...
        }
        {
          ...
          end_idx: -1
          top_type: broadcast
          top_signame: pwrmgr_aon_pwr_nvm
          index: -1
        }
        {
          name: esc_rst_tx
  ...
  alert_connections:
  {
    module_uart0:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[0:0]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[0:0]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[0:0]
      comments:
      [
    ...
    module_uart1:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[1:1]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[1:1]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[1:1]
      comments:
      [
    ...
    module_gpio:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[2:2]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[2:2]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[2:2]
      comments:
      [
    ...
    module_spi_device:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[3:3]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[3:3]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[3:3]
      comments:
      [
    ...
    module_spi_host0:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[4:4]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[4:4]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[4:4]
      comments:
      [
    ...
    module_rv_timer:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[5:5]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[5:5]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[5:5]
      comments:
      [
    ...
    module_usbdev:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[6:6]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[6:6]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[6:6]
      comments:
      [
    ...
    module_pwrmgr_aon:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[7:7]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[7:7]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[7:7]
      comments:
      [
    ...
    module_rstmgr_aon:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[9:8]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[9:8]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[9:8]
      comments:
      [
    ...
    module_clkmgr_aon:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[11:10]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[11:10]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[11:10]
      comments:
      [
    ...
    module_pinmux_aon:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[12:12]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[12:12]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[12:12]
      comments:
      [
    ...
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[13:13]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[13:13]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[13:13]
      comments:
      [
    ...
    module_flash_ctrl:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[18:14]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[18:14]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[18:14]
      comments:
      [
    ...
    module_rv_plic:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[19:19]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[19:19]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[19:19]
      comments:
      [
    ...
    module_aes:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[21:20]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[21:20]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[21:20]
      comments:
      [
    ...
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[22:22]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[22:22]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[22:22]
      comments:
      [
    ...
    module_rom_ctrl:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[23:23]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[23:23]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[23:23]
      comments:
      [
    ...
    module_rv_core_ibex:
    {
      tx_expr: outgoing_alert_englishbreakfast_tx_o[27:24]
      rx_expr: outgoing_alert_englishbreakfast_rx_i[27:24]
      async_expr: AsyncOnOutgoingAlertEnglishbreakfast[27:24]
      comments:
      [
    ...
    [
      {
        package: pwrmgr_pkg
        struct: pwr_nvm
        signame: pwrmgr_aon_pwr_nvm
        width: 1
        type: uni
        end_idx: -1
        act: rcv
        suffix: ""
        default: pwrmgr_pkg::PWR_NVM_DEFAULT
      }
      {
        package: pwrmgr_pkg
        struct: pwr_rst_req
