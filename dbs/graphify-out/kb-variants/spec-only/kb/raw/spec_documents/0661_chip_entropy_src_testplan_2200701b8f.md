# Spec Document: opentitan/hw/top_earlgrey/data/ip/chip_entropy_src_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\ip\chip_entropy_src_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\ip\chip_entropy_src_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 14750
  ...
  testpoints: [
    ...
    },
    {
      ...
      desc: '''Verify that the software can observe samples fast enough to extract many contiguous samples.
            ...
            - The procedure must be tested with a disablement and a re-enablement of ENTROPY_SRC.
