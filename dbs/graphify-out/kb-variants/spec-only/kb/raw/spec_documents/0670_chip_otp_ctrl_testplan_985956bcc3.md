# Spec Document: opentitan/hw/top_earlgrey/data/ip/chip_otp_ctrl_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\ip\chip_otp_ctrl_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\ip\chip_otp_ctrl_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 13108
  ...
  testpoints: [
    ...
    }
    {
      ...
      desc: '''Verify that the SW can read / write the prim tlul interface.
            ...
            - For sival, this test can only run on open-source RTL in test_unlocked or rma state.
    ...
    }
    {
      ...
      desc: '''Verify accessibility of all partitions except life_cycle partition.
    ...
    }
    {
      ...
      desc: '''Verify check_timeout feature.
