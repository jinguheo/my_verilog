# Spec Document: opentitan/hw/top_englishbreakfast/ip_autogen/pinmux/doc/interfaces.md

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_englishbreakfast\ip_autogen\pinmux\doc\interfaces.md`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_englishbreakfast\ip_autogen\pinmux\doc\interfaces.md`
- Original extension: `.md`
- Original bytes: 21253

## Content

# Hardware Interfaces

<!-- BEGIN CMDGEN util/regtool.py --interfaces ./hw/top_englishbreakfast/ip_autogen/pinmux/data/pinmux.hjson -->
...
|:--------------------------|:-------------------------------|:--------|:------|--------:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| lc_hw_debug_clr           | lc_ctrl_pkg::lc_tx             | uni     | rcv   |       1 | Debug clear signal coming from life cycle controller, used for HW strap qualification.                                                                                                                                                                                                                                                                                                               |
...
| PINMUX.LC_HW_DEBUG_CLR.INTERSIG.MUBI    | The life cycle hardware debug clear signal is multibit encoded.                                                                                                                                                                                |
