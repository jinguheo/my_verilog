# Spec Document: opentitan/hw/top_earlgrey/data/ip/chip_sysrst_ctrl_testplan.hjson

- Project: `opentitan`
- Original source: `D:\MyWork\verilog\dbs\opentitan\hw\top_earlgrey\data\ip\chip_sysrst_ctrl_testplan.hjson`
- Exported path: `D:\MyWork\verilog\out\spec_documents_20260514_204108\opentitan\hw\top_earlgrey\data\ip\chip_sysrst_ctrl_testplan.hjson`
- Original extension: `.hjson`
- Original bytes: 10283
  ...
  testpoints: [
    ...
    }
    {
      ...
      desc: '''Verify the SYSRST ctrl can detect an input combination to signal an interrupt.
            ...
            - Verify separately, each key combination successfully generates an interrupt.
            '''
